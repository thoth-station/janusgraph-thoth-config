...
if (mgmt.getPropertyKey('adviser_error') == null)
  mgmt.makePropertyKey('adviser_error').dataType(Boolean.class).cardinality(Cardinality.SINGLE).make()

if (mgmt.getPropertyKey('adviser_stack_index') == null)
  mgmt.makePropertyKey('adviser_stack_index').dataType(Integer.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('artifact_hash_sha256') == null)
  mgmt.makePropertyKey('artifact_hash_sha256').dataType(String.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('buildtime_environment_name') == null)
  mgmt.makePropertyKey('buildtime_environment_name').dataType(String.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('cpu_physical_cpus') == null)
  mgmt.makePropertyKey('cpu_physical_cpus').dataType(Integer.class).cardinality(Cardinality.SINGLE).make()

if (mgmt.getPropertyKey('cuda_version') == null)
  mgmt.makePropertyKey('cuda_version').dataType(String.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('index_url') == null)
  mgmt.makePropertyKey('index_url').dataType(String.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('os_name') == null)
  mgmt.makePropertyKey('os_name').dataType(String.class).cardinality(Cardinality.SINGLE).make()

if (mgmt.getPropertyKey('os_version') == null)
  mgmt.makePropertyKey('os_version').dataType(String.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('package_name') == null)
  mgmt.makePropertyKey('package_name').dataType(String.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('python_version') == null)
  mgmt.makePropertyKey('python_version').dataType(String.class).cardinality(Cardinality.SINGLE).make()

if (mgmt.getPropertyKey('ram_size') == null)
  mgmt.makePropertyKey('ram_size').dataType(Integer.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('solver_name') == null)
  mgmt.makePropertyKey('solver_name').dataType(String.class).cardinality(Cardinality.SINGLE).make()

if (mgmt.getPropertyKey('solver_version') == null)
  mgmt.makePropertyKey('solver_version').dataType(String.class).cardinality(Cardinality.SINGLE).make()
...
if (mgmt.getPropertyKey('version_range') == null)
  mgmt.makePropertyKey('version_range').dataType(String.class).cardinality(Cardinality.SINGLE).make()
