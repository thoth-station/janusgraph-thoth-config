...
if (mgmt.getPropertyKey('inspection_document_id') == null)
    mgmt.makePropertyKey('inspection_document_id').dataType(String.class).cardinality(org.janusgraph.core.Cardinality.SINGLE).make()

if (mgmt.getPropertyKey('run_error') == null)
    mgmt.makePropertyKey('run_error').dataType(Boolean.class).cardinality(org.janusgraph.core.Cardinality.SINGLE).make()

if (mgmt.getPropertyKey('build_error') == null)
    mgmt.makePropertyKey('build_error').dataType(Boolean.class).cardinality(org.janusgraph.core.Cardinality.SINGLE).make()
...
def python_package_version = mgmt.makeVertexLabel('python_package_version').make()

def lbl = mgmt.getPropertyKey('__label__')
def type = mgmt.getPropertyKey('__type__')
...
println "PythonPackageVersion schema and byPythonPackageVersion index creation done!"
